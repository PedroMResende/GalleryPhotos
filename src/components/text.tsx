...
// 	•	Por padrão, ele é um <span>.
// 	•	Mas  pode passar as="h1", as="p", as="label", etc.
// Se  usasse <span> fixo no JSX, não poderia renderizar um <h1> ou <p> sem criar outro componente ou condicional.
// O createElement permite que o tipo do elemento seja dinâmico
