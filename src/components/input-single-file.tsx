...
export default function InputSingleFile({
    ...
    // propriedade truncate do tailwind faz com que quando você digite uma label e ela passe do tamanho da div, apareça reticências. 
        ...
        <div>
            ...
            <div className="w-full relative group cursor-pointer">
                ...
                <div className={inputSingleFileVariants({size})}>
                    ...
                    <Text variant="label-medium" className="text-placeholder text-center">
                        Arraste o arquivo arquivo aqui 
                        <br/>
            ...
            <div className="flex flex-col gap-1 mt-1">
                ...
                {formFile && !isValidSize() && 
                    <Text variant="label-small" className="text-accent-red"> Tamanho do arquivo inválido </Text>
                }
            ...
            <div className="flex gap-3 items-center border border-solid border-border-primary rounded mt-5 p-3">
                ...
                <div className="flex flex-col">
                    <div className="truncate max-w-80 mt-3">
