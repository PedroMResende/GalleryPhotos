...
import DialogContent, { DialogBody, DialogHeader, DialogFooter } from "../components/dialog";
...
export default function PageComponent() {
	...
	return (
		<div className="grid gap-7 p-6">
			...
			<div className="h-12 w-2xs">
				<InputText icon={SearchIcon} placeholder="busque algo aqui"/>
			</div>
			<div>
				<InputCheckbox/>
			</div>
